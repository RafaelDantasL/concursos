...
// URL do Web App do Google Apps Script para upload e delete de arquivos
const UPLOAD_URL = 'https://script.google.com/macros/s/AKfycbwN4Fs8DdAUjrexKOHcg6UxICsuabXXaXcvNg3J6h8C_d3ktt2L1vtdnWzs36OdFRw/exec'; // Substitua pelo seu URL
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    saveButton.addEventListener('click', async () => {
        ...
        try {
            ...
            // Chamar o Apps Script para fazer upload
        ...
        newSaveButton.addEventListener('click', async () => {
            ...
            try {
                ...
                if (file) {
                    ...
                    if (uploadResponse.status === 'success') {
                        downloadLink = uploadResponse.downloadLink;
    ...
    async function deleteEbook(ebookId, fileId) {
        ...
        try {
            ...
            // Excluir o arquivo do Google Drive via Apps Script
    ...
    async function uploadFileToDrive(fileName, fileData) {
        try {
            const response = await fetch(UPLOAD_URL, {
                ...
                body: JSON.stringify({ action: 'upload', fileName: fileName, fileData: fileData })
            });
    ...
    async function deleteFileFromDrive(fileId) {
        try {
            ...
            throw new Error('Erro ao excluir arquivo do Drive.');
        }
    }
